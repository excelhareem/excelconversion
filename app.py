...
if uploaded_file:
    try:
        ...
        required_columns = [
            ...
            "Rate", "UoM", "Value of Sales Excluding Sales Tax", "Reason",
            "Reason Remarks", "Sales Tax/ FED in ST Mode", "Extra Tax",
            "ST Withheld at Source", "SRO No. / Schedule No.", "Item Sr. No.",
            "Further Tax", "Fixed / notified value or Retail Price / Toll Charges",
            "Total Value of Sales."
        ]

        # --- Generate/transform invoice details ---
        n = len(df)
        ...
        final_df = df if not final_cols else df[final_cols]
